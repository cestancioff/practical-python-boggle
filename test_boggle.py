...
class TestBoggle(unittest.Testcase):
    ...
    def test_grid_is_filled_with_letters(self):
        ...
        """" 
        Esnure that each of the coordinates in the the grid contains letters
        """
    ...
    def test_all_grid_neighbours(self):
        ...
        for pos in grid:
            others = list(grid) #creates a new list from the dicionary's keys
            others.remove(pos)
    ...
    def test_search_grid_for_words(self):
        ...
        self.assertTure(twoLetterWord in foundWords)
    ...
    """""
     test that 'get dictionary' function returns a dictionary
  that has a lenght greather than 0
     """
